...
export class PrometheusMetricsService {
  ...
  readonly agentExecutionDuration = new Histogram({
    name: 'fuzzyllama_agent_execution_duration_seconds',
  ...
  readonly currentGateStatus = new Gauge({
    name: 'fuzzyllama_current_gate_status',
  ...
  readonly testCoverage = new Gauge({
    name: 'fuzzyllama_test_coverage_percentage',
  ...
  readonly dbQueryDuration = new Histogram({
    name: 'fuzzyllama_db_query_duration_seconds',
