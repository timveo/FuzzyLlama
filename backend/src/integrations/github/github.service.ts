...
export class GitHubService {
  ...
  async createRepository(
    ...
    try {
      ...
      const { data } = await octokit.rest.repos.createForAuthenticatedUser({
        name: options.name,
        description: options.description || 'Generated by LayerCake',
  ...
  async exportProjectToGitHub(
    ...
    try {
      ...
      const { repoUrl, cloneUrl } = await this.createRepository(accessToken, {
        name: finalRepoName,
        description: `LayerCake Project: ${project.name || 'Untitled'}`,
        private: true,
      });
      ...
      const commitResult = await this.gitIntegration.commitAll(
        projectId,
        'Initial commit - Generated by LayerCake',
        {
          name: project.owner.name || 'LayerCake User',
      ...
      await this.prisma.project.update({
        ...
        data: {
          ...
          githubRepoName: `${githubUser.login}/${finalRepoName}`,
        },
      });
  ...
  async pushUpdatesToGitHub(
    ...
    try {
      ...
      const commitResult = await this.gitIntegration.commitAll(
        projectId,
        commitMessage || 'Update - Generated by LayerCake',
        {
          name: project.owner.name || 'LayerCake User',
          email: project.owner.email,
        },
  ...
  async createReadme(projectId: string): Promise<string> {
    ...
    const readme = `# ${project.name || 'LayerCake Project'}

${project.description || 'Project generated by LayerCake AI'}
...
- **Generated by**: [LayerCake](https://layercake.dev)

## Gates Approved

${project.gates.map((gate) => `- ✅ ${gate.gateType} (${gate.approvedAt.toLocaleDateString()})`).join('\n')}
...
🤖 Generated with [LayerCake](https://layercake.dev) - AI-Powered Software Factory
`;
